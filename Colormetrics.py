...
def add_color_data(b_id, df):
    '''
    Insert colormetrics data into the graph database.
...
def generate_color_data(b_id, fp):
    '''
    Generates colormetrics data for a given batch and inserts that data into the graph database.
